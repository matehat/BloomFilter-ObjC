...
typedef struct _bloom_filter_s bloom_filter_s;

/**
 * A value stored in a @ref bloom_filter_s.
 */

typedef void *bloom_filter_value;
...
typedef unsigned long (*bloom_filter_hash_func)(bloom_filter_value data);
...
void bloom_filter_insert(bloom_filter_s *bloomfilter, bloom_filter_value value);
...
int bloom_filter_query(bloom_filter_s *bloomfilter, bloom_filter_value value);
...
bloom_filter_s *bloom_filter_union(bloom_filter_s *filter1, 
